...
import { ToggleActiveWeeklySlotUseCase } from "./toggle.active.weekly.slot.usecase";
...
export const toggleActiveWeeklyAvailabilityUseCase = new ToggleActiveWeeklySlotUseCase(weeklyAvailabilityRepository);
