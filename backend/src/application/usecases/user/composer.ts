...
export const verifyOTPUsecase = new VerifyOtpUsecase(redisService, userRepository, notifyUserUseCase);
export const signupUseCase = new SignupUseCase(userRepository, tokenService, verifyOTPUsecase, createUserProgressUseCase, hashService, notifyUserUseCase);
export const sendOtpUseCase = new SendOtpUsecase(emailService, userRepository, redisService);
export const googleAuthUsecase = new GoogleAuthUsecase(userRepository, tokenService, hashService, notifyUserUseCase, createUserProgressUseCase);
...
export const requestSessionUsecase = new RequestSessionUseCase(sessionRepository, mentorRepository, getAvailabilityUsecase, notifyUserUseCase);
export const getSessionsByUserUsecase = new GetSessionsByUserUseCase(sessionRepository, rescheduleRequestRepository);
