...
import { RejectWithdrawalRequestUseCase } from "./reject.withdrawal.request.usecase";
...
export const rejectWithdrawalRequestUseCase = new RejectWithdrawalRequestUseCase(withdrawalRequestRepository, walletRepository, notifyUserUseCase, userRepository);
