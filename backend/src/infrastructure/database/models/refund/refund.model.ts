...
export interface IRefundDocument extends Document {
   ...
   sessionId: mongoose.Types.ObjectId; // Related session
   paymentId: string; // Gateway payment ID (Stripe/Razorpay)
   userId: mongoose.Types.ObjectId; // User getting refunded
   ...
   walletTransactionId?: mongoose.Types.ObjectId; // Link to WalletTransaction if WALLET method
