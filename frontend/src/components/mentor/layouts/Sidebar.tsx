...
import { ClipboardList, Star, Users, Menu, BarChart3, BookOpenText, Clock, Calendar } from "lucide-react";
...
export function MentorSidebar() {
	...
	const routes: Route[] = [
		...
		},
		{
			...
			icon: Calendar,
			href: "/mentor/reschedule-requests",
			active: pathname === "/mentor/reschedule-requests",
		},
		{
			title: "Availability",
			icon: Clock,
