...
export function WalletBalanceCard({ balance, isLoading, isWalletExists, handleCreateWallet, isRequestedWithdrawal }: WalletBalanceCardProps) {
	return isLoading ? (
		...
		<Card className="bg-gradient-to-br from-blue-600 to-blue-700 text-white shadow-xl lg:col-span-2">
			<CardContent className="p-4 sm:p-6">
				{!isWalletExists ? (
					...
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3">
						<div className="space-y-4">
							...
							{isRequestedWithdrawal && <p className="text-white bg-blue-500 text-center py-1 px-4 rounded-lg text-sm font-medium border border-blue-300">We're processing your withdrawal request!</p>}{" "}
						</div>
