...
// Validation function
const validateFormData = (data: MentorApplicationFormData): { isValid: boolean; errors: string[] } => {
	const errors: string[] = [];
			...
			try {
				...
				if (mentorData && user?.mentorRequestStatus === "rejected") {
					setFormData({
						...
						sessionFormat: mentorData.sessionFormat || "both",
						sessionTypes: mentorData.sessionTypes || [],
						pricing: mentorData.pricing || "free",
						hourlyRate: mentorData.hourlyRate ? String(mentorData.hourlyRate) : "",
