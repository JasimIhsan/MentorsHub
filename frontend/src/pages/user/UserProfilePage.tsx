...
import { getFullName, updateUser } from "@/store/slices/authSlice";
...
export default function UserProfilePage() {
  ...
  const [originalFormData, setOriginalFormData] = useState<UpdateProfileFormData | null>(null); // Store original data
  ...
  useEffect(() => {
    if (user) {
      ...
      if (!originalFormData) {
        setOriginalFormData(initialData); // Set original data only once
      }
    }
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            ...
            <SkillsInterestsSection
              ...
              errors={errors}
            />
            <SessionHistorySection user={user} pastSessions={pastSessions} upcomingSessions={upcomingSessions} />
          </div>
